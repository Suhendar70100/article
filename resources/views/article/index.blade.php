...
@section("content")
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Pengaturan /</span> Artikel</h4>
        <!-- Column Search -->
        <div class="card">
    ...
    @include('article.modal-detail')
@endsection
@push("my-scripts")
    <script src="{{asset('javascripts/article/index.js')}}"></script>
@endpush